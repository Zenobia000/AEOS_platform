...
owner: CTO
tier: 3
related: [DEV-PLAN-PHASE1-2026-05, PROJ-001, ADR-0011, ADR-0012, ADR-0013, CR-0001, SEC-001, OBS-001, TEST-001, RUNBOOK-001]
---
...
- [ ] `docs/1-decisions/ADR-0001` ~ `ADR-0013` — 全部讀過一次（重點 ADR-0006 auth、ADR-0007 隔離、ADR-0011 backend 語言、ADR-0012 Runtime 策略修正、**ADR-0013 Skill Routing Rule**）
- [ ] `docs/4-exploration/CR-0001-multi-vertical-framework.md` — Multi-Vertical Framework CIA + 實作完成記錄
...
| 2026-05-26 | §D.3 必讀補 ADR-0013（Skill Routing Rule）+ CR-0001（Multi-Vertical Framework）；frontmatter related 同步 | CTO |
